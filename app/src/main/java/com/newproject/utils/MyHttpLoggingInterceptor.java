...
import com.newproject.base.BaseApplication;
import com.newproject.constant.UrlConst;
import com.newproject.entity.RefreshEntity;
            ...
            if (logHeaders) {
                ...
                if (logBody && HttpHeaders.hasBody(clone)) {
                    ...
                    if (isPlaintext(responseBody.contentType())) {
                        ...
                        if (msg.equals("token is expire")) {
                            refresh(clone.request().url() + "");
                        } else if (msg.equals("token error")) {
...
//                            LocalBroadcastManager.getInstance(activity).sendBroadcast(new Intent(Action.showDialog));
//                            activity.startActivity(new Intent(activity, LoginActivity.class).putExtra(PreConst.OTHER_LOGIN, PreConst.OTHER_LOGIN));
    ...
    public static void refresh(final String url) {
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put("token", SpPersonUtil.getToken(BaseApplication.getApp()));
        OkGo.<String>post(UrlConst.REFRESH_TOKEN)
                .params(hashMap)
                    ...
                    public void onSuccess(com.lzy.okgo.model.Response<String> response) {
                        try {
                            ...
                            if (jsonObject.getInt("code") == 200) {
                                ...
                                SpPersonUtil.upToken(BaseApplication.getApp(), refreshEntity.getData());
                                RefreshToken refreshToken = new RefreshToken();
